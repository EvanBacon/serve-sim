...
export function SimulatorResizeSizeBadge({
  ...
  return (
    <div
      aria-hidden="true"
      className="absolute right-3 bottom-3 z-20 pointer-events-none select-none rounded-lg px-2.5 py-1 text-[11.5px] font-mono leading-none tracking-wide text-white/95 bg-panel-bg shadow-[0_1px_2px_rgba(0,0,0,0.18),0_6px_18px_rgba(0,0,0,0.28),inset_0_0_0_1px_rgba(255,255,255,0.06)] backdrop-blur-md backdrop-saturate-150 whitespace-nowrap"
      style={{
        opacity: visible ? 1 : 0,
