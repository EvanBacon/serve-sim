...
export function GridPanel({
  ...
  return (
    <Panel open={open} width={width}>
      ...
      <div className="flex-1 min-h-0 overflow-y-auto p-3.5 grid auto-rows-[minmax(300px,auto)] gap-3 content-start [grid-template-columns:repeat(auto-fill,minmax(200px,1fr))]">
